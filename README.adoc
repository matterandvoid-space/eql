image:https://img.shields.io/clojars/v/space.matterandvoid/eql.svg[link=https://clojars.org/space.matterandvoid/eql]
https://cljdoc.org/d/space.matterandvoid/eql[image:https://cljdoc.org/badge/space.matterandvoid/eql[cljdoc badge]]
...
- This fork removes the specs from the core namespace so users of this library can opt-in to using specs instead of opting out.
